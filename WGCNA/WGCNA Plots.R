...
colnames(datTraits)[2] = "Growth Media"
...
#edit the labels to reflect that now the blue module = module 1 and the turquoise module = module 2
module_names[1:2] = c("Module 2", "Module 1")
rownames(moduleTraitCor)[1] = "MEorange"
names(MEs)[1] = "MEorange"
