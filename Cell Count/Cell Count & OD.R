...
Neg1_data$shape = ifelse(Neg1_data$Group == "Control",16,17)
...
Neg5_data$shape = ifelse(Neg5_data$Group == "Control",16,17)
...
plot(Neg1_data$Day,Neg1_data$Count,col = Neg1_data$col, pch = Neg1_data$shape,xlab = "Time (Day)",ylab = "CFU/ml",main = "(A) Cell Abundance at -1C (Estimated Growth Curve)", ylim = c(0,7e+08))
...
plot(Neg5_data$Day,Neg5_data$Count,col = Neg5_data$col, pch = Neg5_data$shape,xlab = "Time (Day)",ylab = "CFU/ml",main = "(B) Cell Abundance at -5C (Estimated Growth Curve)", ylim = c(0,7e+08))
...
plot(Neg1_data$Day,Neg1_data$Count,col = Neg1_data$col, pch = Neg1_data$shape,xlab = "Time (Day)",ylab = "CFU/ml",main = "(C) Cell Abundance at -1C (Loess Smoothing)", ylim = c(0,7e+08))
...
plot(Neg5_data$Day,Neg5_data$Count,col = Neg5_data$col, pch = Neg5_data$shape,xlab = "Time (Day)",ylab = "CFU/ml",main = "(D) Cell Abundance at -5C (Loess Smoothing)", ylim = c(0,7e+08))
